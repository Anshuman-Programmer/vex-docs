...
function Doc() {
  ...
  return (
    <div>
      ...
      <Button color="orange" butttonType="filled" size="regular" className="hidden md:inline-flex h-10">
        <Icon name="people" size="md"/>SHARE
      </Button>

      <img className="rounded-full cursor-pointer h-10 w-10 ml-2" src={session.user.image} alt="user_image"/>
